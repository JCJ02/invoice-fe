              ...
              {isLoading ? (
                ...
                data?.data?.clients?.map((client: ClientType) =>
                  client?.invoices?.length
                    ? client?.invoices?.map(
                        (invoice: InvoiceType, index: number) => (
                          <TableRow
                            key={invoice.id}
                            className={
...
//                         )
//                         .map((invoice: InvoiceType, index: number) => (
//                           <TableRow
//                             key={invoice.id}
//                             className={
//                               index % 2 === 0 ? "bg-[#FBE9EA]" : "bg-white"
...
//               // data && data?.data.invoices.length > 0 ? (
...
//               //         <TableCell>
//               //           ₱{" "}
//               //           {parseFloat(invoice.totalOutstanding).toLocaleString()}{" "}
//               //           PHP
//               //         </TableCell>
//               //         <TableCell className="flex items-center gap-1">
//               //           <Button className="bg-white px-1 lg:px-1 py-1 text-black text-sm">
...
//               {generatePaginationLinks(
//                 currentPage,
//                 Math.ceil((data?.data?.totalInvoices ?? 0) / limit)
//               ).map((page) => (
//                 <PaginationItem key={page}>
//                   <PaginationLink
//                     href="#"
...
//                   href="#"
//                   onClick={() => handlePageChange(currentPage + 1)}
//                   disabled={data && data?.data?.invoices?.length < limit}
//                   className="text-xs md:text-md lg:text-lg"
//                 />
//               </PaginationItem>
//             </PaginationContent>
...
//           isOpen={isNewInvoicesFormOpen}
//           onClose={closeNewInvoicesForm}
//           className="flex-col overflow-y-scroll [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 h-screen w-full"
//         >
//           {isNewInvoicesFormOpen && selectedClient ? (
//             <NewInvoicesForm
//               client={selectedClient}
